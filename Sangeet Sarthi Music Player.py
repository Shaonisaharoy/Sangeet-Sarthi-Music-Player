...
window = tk.Tk()
window.title("Sangeet Sarthi Music Player")
...
background_photo = tk.PhotoImage(file="animation.gif")
...
l_music_player = tk.Label(window, text="Sangeet Sarthi Music Player", font=("Helvetica", 20, "bold"))
l_music_player.pack(pady=20)  # Increased padding

# Create a button to select the music folder
btn_select_folder = tk.Button(window, text="Select Music Folder",
...
btn_toggle_list = tk.Button(window, text="Music List", command=toggle_music_list,
